...
/** columns and relationships of "columns" */
export type ColumnsTasks_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Tasks_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
  order_by?: InputMaybe<Array<Tasks_Order_By>>;
...
export type Tasks = {
  __typename?: 'tasks';
  assigned_id?: Maybe<Scalars['uuid']['output']>;
  /** An object relationship */
  column: Columns;
...
export type Tasks_Bool_Exp = {
  ...
  assigned_id?: InputMaybe<Uuid_Comparison_Exp>;
...
export type Tasks_Insert_Input = {
  assigned_id?: InputMaybe<Scalars['uuid']['input']>;
...
export type Tasks_Max_Order_By = {
  assigned_id?: InputMaybe<Order_By>;
